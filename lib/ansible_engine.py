...
class AnsibleEngine:
    ...
    def _config_to_variables(self, runtime_vars: Dict[str, str] = None) -> Dict[str, Any]:
    ...
    def generate_playbook(self, task_name: str, variables: Dict[str, Any] = None) -> str:
    ...
    def execute_task(self, task_name: str, variables: Dict[str, str] = None, verbose: bool = False) -> bool:
        ...
        try:
            ...
            print("Error: ansible-playbook command not found. Please install ansible-core:")
    ...
    def show_available_variables(self) -> None:
        ...
        categories = {
            ...
            'Build Settings': ['build_local', 'build_use_branch', 'build_image', 'build_custom_registry', 'build_manifests_only'],
        }
